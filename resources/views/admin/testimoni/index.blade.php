                            ...
                            @foreach ($testimoni as $item)
                                <tr>
                                    ...
                                    <td data-header="Gambar"><a href="{{ $item->gambar() }}"
                                            data-caption="{{ $item->nama }}" data-fancybox="gallery"> <img
                                                src="{{ $item->gambar() }}" alt="" class="m-2 rounded"
                                                style="width: 110px; height: 70px;" alt="gambar"> </td>
                                    </a>
                                    <td data-header="Nama">{{ $item->name }}</td>
                                    <td data-header="Instansi"> {{ $item->instansi }} </td>
                                    <td data-header="Testimoni"> {{ $item->testimoni }} </td>
                                    <td>
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('testimoni.update', $item->id) }}" method="POST"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group ">
                                                            <input type="text" value="{{ $item->instansi }}"
                                                                placeholder="Masukkan instansi" name="instansi"
                                                                autocomplete='off'
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" value="{{ $item->testimoni }}"
                                                                placeholder="Masukkan testimoni" name="testimoni"
                                                                autocomplete='off'
                ...
                <div class="modal-body">
                    <form action="{{ route('testimoni.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Nama</label>
                            <div class="input-group ">
                                <input type="text" value="{{ old('name') }}" placeholder="Masukkan Nama"
                        ...
                        <div class="form-group">
                            <label>Instansi</label>
                            <div class="input-group ">
                                <input type="text" value="{{ old('instansi') }}" placeholder="Masukkan instansi"
                                    name="instansi" autocomplete='off'
                        ...
                        <div class="form-group">
                            <label>Testimoni</label>
                            <div class="input-group ">
                                <input type="text" value="{{ old('testimoni') }}" placeholder="Masukkan testimoni"
                                    name="testimoni" autocomplete='off'
                                    class="form-control @error('testimoni') is-invalid @enderror" required>
                                @error('testimoni')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
