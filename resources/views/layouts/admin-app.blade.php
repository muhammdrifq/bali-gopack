...
<head>
    ...
    <title>Admin Presensi Digma</title>
...
<body>
    <div class="wrapper">
        ...
        @include('layouts.partials.admin-app.navbar')

        @include('layouts.partials.admin-app.sidebar')
        ...
        <div class="main-panel">
            ...
            @include('layouts.partials.admin-app.footer')
